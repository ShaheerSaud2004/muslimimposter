...
export const arabicTranslations: Record<string, string> = {
  ...
  // Angels
  'Jibril': 'Angel Gabriel – brought revelation',
  'Mikail': 'Angel Michael – provision, rain',
  'Israfil': 'Angel – will blow the Trumpet',
  'Azrael': 'Angel of Death',
  'Malik': 'Guardian of Hell',
  'Kiraman Katibin': 'Recording angels – right and left',
  'Munkar': 'Angel – questions in the grave',
  'Nakir': 'Angel – questions in the grave',

  // Women in Islam (hints for game)
  'Khadija (RA)': 'First wife of the Prophet ﷺ',
  'Aisha (RA)': 'Wife of the Prophet ﷺ – scholar of Islam',
  'Fatima (RA)': 'Daughter of the Prophet ﷺ',
  'Maryam': 'Mother of Prophet Isa (AS)',
  'Asiya': 'Wife of Pharaoh – believed in Musa (AS)',
  'Sumayyah': 'First martyr of Islam',
  'Umm Aiman (RA)': 'Companion – nursed the Prophet ﷺ',
  'Zainab bint Muhammad (RA)': 'Eldest daughter of the Prophet ﷺ',
  'Nusaybah bint Ka\'ab': 'Fought at Uhud – shielded the Prophet ﷺ',
  'Safiyyah (RA)': 'Wife of the Prophet ﷺ',
  'Hafsa (RA)': 'Wife of the Prophet ﷺ – daughter of Umar (RA)',
  'Umm Salamah (RA)': 'Wife of the Prophet ﷺ',
